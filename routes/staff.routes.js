...
import { createStaff, getStaffs, getStaffNames, getStaffsStats, getStaff, updateStaff, toggleStaffStatus, } from "../controllers/staff.controller.js";
...
router.get("/names", getStaffNames);              // List (with staff-wise access)
